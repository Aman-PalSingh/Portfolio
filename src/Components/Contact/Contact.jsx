		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='https://github.com/Aman-PalSingh'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/amanpal-singh/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
				...
				<h3>amanpalsingh777@gmail.com</h3>
			...
			>
				Designed and build by Aman Pal Singh, 2022 All rights
				reserved.
			</div>
		</footer>
	);
