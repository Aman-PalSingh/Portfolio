	...
	return (
		...
		>
			...
			<div className={styles.second}>
				...
				>
					Hello! Everyone I am Aman Pal Singh .
					<br />A highly dedicated and passionate full-stack web developer with excellent
					administrative and communication skills and the ability to write quality code.
					Self motivated, quick-learner and curious with proficiency in Backend Development.
